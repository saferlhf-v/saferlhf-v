...
from safe_rlhf_v.utils.template_registry import register_template
...
@register_template('AA_TI2T_ORI')
class AA_TI2T_ORI(BaseFormatter):
    system_prompt: str = ''
...
@register_template('Harmless_RM')
class Harmless_RM(BaseFormatter):
    system_prompt: str = ''
...
@register_template('DPO_Harmless')
class DPO_Harmless(BaseFormatter):
    system_prompt: str = ''
